  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch sponsors
        const sponsorsRes = await fetch('http://localhost:4000/api/sponsors');
        const sponsorsData = await sponsorsRes.json();

        // Fetch items
        const itemsRes = await fetch('http://localhost:4000/api/sponsors/items/all');
        const itemsData = await itemsRes.json();

        // Fetch stats
        const statsRes = await fetch('http://localhost:4000/api/sponsors/stats/overview');
